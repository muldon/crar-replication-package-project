...
public class Post {
	...
	@Column(name="hottopics")
	private String hotTopics;
	
	@Column(name="topscoredanswers")
    ...
    private String sentenceVectors;
	...
	public String getSentenceVectors() {
		return sentenceVectors;
	}

	public void setSentenceVectors(String sentenceVectors) {
